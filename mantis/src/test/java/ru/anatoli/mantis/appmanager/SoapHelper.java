...
public class SoapHelper {
    ...
    public Issue createIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        String[] categories = mantisConnect.mc_project_get_categories("administrator", "root", BigInteger.valueOf(issue.getProject().getId()));
        ...
        BigInteger issueId = mantisConnect.mc_issue_add("administrator", "root", issueData);
        IssueData createdIssueData = mantisConnect.mc_issue_get("administrator", "root", issueId);
