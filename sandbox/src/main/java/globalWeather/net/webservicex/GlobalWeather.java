 ...
 * 2017-06-03T00:21:45.011+03:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "GlobalWeather", 
                  wsdlLocation = "file:src/main/resources/globalweather.wsdl",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/globalweather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/globalweather.wsdl");
        }
        WSDL_LOCATION = url;
    }
