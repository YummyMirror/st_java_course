...
public class PointTest {
    ...
    public void distanceTest() {
        ...
        Assert.assertEquals(p.distance(p1, p2), 7.0710678118654755);
    }
    ...
    public void distanceTest2() {
        ...
        Assert.assertEquals(p.distance(p1, p2), 14.142135623730951);
    }
    ...
    public void distanceTest3() {
        ...
        Assert.assertEquals(p.distance(p1, p2), 69.29646455628166);
    }
}
